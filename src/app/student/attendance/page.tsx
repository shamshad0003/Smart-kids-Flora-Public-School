    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
                {[
                    { label: "Overall", value: `${pct}%`, color: "bg-blue-50 border-blue-200 text-blue-700" },
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-100">
                    <h2 className="font-bold text-slate-900">Attendance History</h2>
                </div>
                {student.attendances.length === 0 ? (
                    <p className="px-6 py-12 text-center text-slate-400">No attendance records yet.</p>
                ) : (
